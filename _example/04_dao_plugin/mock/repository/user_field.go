...
type UserFieldFindByFieldIDExpect struct {
	expect        *UserFieldExpect
	isOutOfOrder  bool
	isAnyTimes    bool
	requiredTimes int
...
func (r *UserFieldFindByFieldIDExpect) Return(r0 *model.UserField, r1 error) *UserFieldFindByFieldIDExpect {
	r.r0 = r0
	r.r1 = r1
	return r
}

func (r *UserFieldFindByFieldIDExpect) Do(action func(a0 context.Context, a1 uint64)) *UserFieldFindByFieldIDExpect {
	r.actions = append(r.actions, action)
	return r
}

func (r *UserFieldFindByFieldIDExpect) OutOfOrder() *UserFieldFindByFieldIDExpect {
	r.isOutOfOrder = true
	return r
}

func (r *UserFieldFindByFieldIDExpect) AnyTimes() *UserFieldFindByFieldIDExpect {
	r.isAnyTimes = true
	return r
}

func (r *UserFieldFindByFieldIDExpect) Times(n int) *UserFieldFindByFieldIDExpect {
	r.requiredTimes = n
	return r
}

func (r *UserFieldMock) FindByFieldID(a0 context.Context, a1 uint64) (r0 *model.UserField, r1 error) {
	if len(r.expect.findByFieldID) == 0 {
		r1 = xerrors.New("cannot find mock method for UserField.FindByFieldID")
		return
	}
	for _, exp := range r.expect.findByFieldID {
		if !reflect.DeepEqual(exp.a0, a0) {
			continue
		}
...
func (r *UserFieldExpect) FindByFieldID(a0 context.Context, a1 uint64) *UserFieldFindByFieldIDExpect {
	exp := &UserFieldFindByFieldIDExpect{
		a0:      a0,
		a1:      a1,
		actions: []func(a0 context.Context, a1 uint64){},
		expect:  r,
	}
	r.findByFieldID = append(r.findByFieldID, exp)
	return exp
}
...
type UserFieldUpdateByFieldIDExpect struct {
	expect        *UserFieldExpect
	isOutOfOrder  bool
	isAnyTimes    bool
	requiredTimes int
...
func (r *UserFieldUpdateByFieldIDExpect) Return(r0 error) *UserFieldUpdateByFieldIDExpect {
	r.r0 = r0
	return r
}

func (r *UserFieldUpdateByFieldIDExpect) Do(action func(a0 context.Context, a1 uint64, a2 map[string]interface{})) *UserFieldUpdateByFieldIDExpect {
	r.actions = append(r.actions, action)
	return r
}

func (r *UserFieldUpdateByFieldIDExpect) OutOfOrder() *UserFieldUpdateByFieldIDExpect {
	r.isOutOfOrder = true
	return r
}

func (r *UserFieldUpdateByFieldIDExpect) AnyTimes() *UserFieldUpdateByFieldIDExpect {
	r.isAnyTimes = true
	return r
}

func (r *UserFieldUpdateByFieldIDExpect) Times(n int) *UserFieldUpdateByFieldIDExpect {
	r.requiredTimes = n
	return r
}

func (r *UserFieldMock) UpdateByFieldID(a0 context.Context, a1 uint64, a2 map[string]interface{}) (r0 error) {
	if len(r.expect.updateByFieldID) == 0 {
		r0 = xerrors.New("cannot find mock method for UserField.UpdateByFieldID")
		return
	}
	for _, exp := range r.expect.updateByFieldID {
		if !reflect.DeepEqual(exp.a0, a0) {
			continue
		}
		if !reflect.DeepEqual(exp.a1, a1) {
...
func (r *UserFieldExpect) UpdateByFieldID(a0 context.Context, a1 uint64, a2 map[string]interface{}) *UserFieldUpdateByFieldIDExpect {
	exp := &UserFieldUpdateByFieldIDExpect{
		a0:      a0,
		a1:      a1,
		a2:      a2,
		actions: []func(a0 context.Context, a1 uint64, a2 map[string]interface{}){},
	...
	r.updateByFieldID = append(r.updateByFieldID, exp)
	return exp
}
...
type UserFieldUpdateByUserIDsExpect struct {
	expect        *UserFieldExpect
	isOutOfOrder  bool
	isAnyTimes    bool
	requiredTimes int
...
func (r *UserFieldUpdateByUserIDsExpect) Return(r0 error) *UserFieldUpdateByUserIDsExpect {
	r.r0 = r0
	return r
}

func (r *UserFieldUpdateByUserIDsExpect) Do(action func(a0 context.Context, a1 []uint64, a2 map[string]interface{})) *UserFieldUpdateByUserIDsExpect {
	r.actions = append(r.actions, action)
	return r
}

func (r *UserFieldUpdateByUserIDsExpect) OutOfOrder() *UserFieldUpdateByUserIDsExpect {
	r.isOutOfOrder = true
	return r
}

func (r *UserFieldUpdateByUserIDsExpect) AnyTimes() *UserFieldUpdateByUserIDsExpect {
	r.isAnyTimes = true
	return r
}

func (r *UserFieldUpdateByUserIDsExpect) Times(n int) *UserFieldUpdateByUserIDsExpect {
	r.requiredTimes = n
	return r
}

func (r *UserFieldMock) UpdateByUserIDs(a0 context.Context, a1 []uint64, a2 map[string]interface{}) (r0 error) {
	if len(r.expect.updateByUserIDs) == 0 {
		r0 = xerrors.New("cannot find mock method for UserField.UpdateByUserIDs")
		return
	}
	for _, exp := range r.expect.updateByUserIDs {
		if !reflect.DeepEqual(exp.a0, a0) {
			continue
		}
		if len(exp.a1) != len(a1) {
...
func (r *UserFieldExpect) UpdateByUserIDs(a0 context.Context, a1 []uint64, a2 map[string]interface{}) *UserFieldUpdateByUserIDsExpect {
	exp := &UserFieldUpdateByUserIDsExpect{
		a0:      a0,
		a1:      a1,
		a2:      a2,
		actions: []func(a0 context.Context, a1 []uint64, a2 map[string]interface{}){},
	...
	r.updateByUserIDs = append(r.updateByUserIDs, exp)
	return exp
}

type UserFieldDeleteByFieldIDExpect struct {
	expect        *UserFieldExpect
	isOutOfOrder  bool
	isAnyTimes    bool
	requiredTimes int
...
func (r *UserFieldDeleteByFieldIDExpect) Return(r0 error) *UserFieldDeleteByFieldIDExpect {
	r.r0 = r0
	return r
}

func (r *UserFieldDeleteByFieldIDExpect) Do(action func(a0 context.Context, a1 uint64)) *UserFieldDeleteByFieldIDExpect {
	r.actions = append(r.actions, action)
	return r
}

func (r *UserFieldDeleteByFieldIDExpect) OutOfOrder() *UserFieldDeleteByFieldIDExpect {
	r.isOutOfOrder = true
	return r
}

func (r *UserFieldDeleteByFieldIDExpect) AnyTimes() *UserFieldDeleteByFieldIDExpect {
	r.isAnyTimes = true
	return r
}

func (r *UserFieldDeleteByFieldIDExpect) Times(n int) *UserFieldDeleteByFieldIDExpect {
	r.requiredTimes = n
	return r
}

func (r *UserFieldMock) DeleteByFieldID(a0 context.Context, a1 uint64) (r0 error) {
	if len(r.expect.deleteByFieldID) == 0 {
		r0 = xerrors.New("cannot find mock method for UserField.DeleteByFieldID")
		return
	}
	for _, exp := range r.expect.deleteByFieldID {
		if !reflect.DeepEqual(exp.a0, a0) {
			continue
		}
		if !reflect.DeepEqual(exp.a1, a1) {
...
func (r *UserFieldExpect) DeleteByFieldID(a0 context.Context, a1 uint64) *UserFieldDeleteByFieldIDExpect {
	exp := &UserFieldDeleteByFieldIDExpect{
		a0:      a0,
		a1:      a1,
		actions: []func(a0 context.Context, a1 uint64){},
		expect:  r,
	}
	r.deleteByFieldID = append(r.deleteByFieldID, exp)
	return exp
}
