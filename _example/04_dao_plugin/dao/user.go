...
func (d *UserImpl) Create(ctx context.Context, value *entity.User) (e error) {
	...
	result, err := d.tx.ExecContext(ctx, query, value.ID, value.Name, value.Sex, value.Age, value.SkillID, value.SkillRank, value.GroupID, value.WorldID, value.FieldID, value.CreatedAt, value.UpdatedAt)
	if err != nil {
...
func (d *UserImpl) FindAll(ctx context.Context) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users`"
	...
	for rows.Next() {
		...
		if err := rows.Scan(&value.ID, &value.Name, &value.Sex, &value.Age, &value.SkillID, &value.SkillRank, &value.GroupID, &value.WorldID, &value.FieldID, &value.CreatedAt, &value.UpdatedAt); err != nil {
...
func (d *UserImpl) FindByGroupID(ctx context.Context, a0 uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `group_id` = ?"
...
func (d *UserImpl) FindByGroupIDs(ctx context.Context, a0 []uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `group_id` IN (%s)"
	args := []interface{}{}
	placeholders := make([]string, 0, len(a0))
	for _, v := range a0 {
		args = append(args, v)
...
func (d *UserImpl) FindByID(ctx context.Context, a0 uint64) (r *entity.User, e error) {
	var value entity.User
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `id` = ?"
...
func (d *UserImpl) FindByIDs(ctx context.Context, a0 []uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `id` IN (%s)"
	args := []interface{}{}
	placeholders := make([]string, 0, len(a0))
	for _, v := range a0 {
		args = append(args, v)
...
func (d *UserImpl) FindByName(ctx context.Context, a0 string) (r *entity.User, e error) {
	var value entity.User
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `name` = ?"
	if err := d.tx.QueryRowContext(ctx, query, a0).Scan(
		&value.ID,
		&value.Name,
		&value.Sex,
...
func (d *UserImpl) FindByNames(ctx context.Context, a0 []string) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `name` IN (%s)"
	args := []interface{}{}
	placeholders := make([]string, 0, len(a0))
	for _, v := range a0 {
		args = append(args, v)
...
func (d *UserImpl) FindBySkillID(ctx context.Context, a0 uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `skill_id` = ?"
	rows, err := d.tx.QueryContext(ctx, query, a0)
	if err != nil {
		return values, xerrors.Errorf("failure query %s: %w", query, err)
	}
...
func (d *UserImpl) FindBySkillIDAndSkillRank(ctx context.Context, a0 uint64, a1 int) (r *entity.User, e error) {
	var value entity.User
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `skill_id` = ? AND `skill_rank` = ?"
...
func (d *UserImpl) FindBySkillIDs(ctx context.Context, a0 []uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `skill_id` IN (%s)"
	args := []interface{}{}
	placeholders := make([]string, 0, len(a0))
	for _, v := range a0 {
		args = append(args, v)
...
func (d *UserImpl) FindByWorldID(ctx context.Context, a0 uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `world_id` = ?"
	rows, err := d.tx.QueryContext(ctx, query, a0)
	if err != nil {
		return values, xerrors.Errorf("failure query %s: %w", query, err)
	}
...
func (d *UserImpl) FindByWorldIDAndFieldID(ctx context.Context, a0 uint64, a1 uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `world_id` = ? AND `field_id` = ?"
...
func (d *UserImpl) FindByWorldIDs(ctx context.Context, a0 []uint64) (r entity.Users, e error) {
	values := entity.Users{}
	query := "SELECT `id`, `name`, `sex`, `age`, `skill_id`, `skill_rank`, `group_id`, `world_id`, `field_id`, `created_at`, `updated_at` FROM `users` WHERE `world_id` IN (%s)"
	args := []interface{}{}
	placeholders := make([]string, 0, len(a0))
	for _, v := range a0 {
		args = append(args, v)
...
func (d *UserImpl) Update(ctx context.Context, value *entity.User) (e error) {
	...
	args := []interface{}{value.Name, value.Sex, value.Age, value.SkillID, value.SkillRank, value.GroupID, value.WorldID, value.FieldID, value.CreatedAt, value.UpdatedAt, value.ID}
	query := "UPDATE `users` SET `name` = ?, `sex` = ?, `age` = ?, `skill_id` = ?, `skill_rank` = ?, `group_id` = ?, `world_id` = ?, `field_id` = ?, `created_at` = ?, `updated_at` = ? WHERE id = ?"
	if _, err := d.tx.ExecContext(ctx, query, args...); err != nil {
		return xerrors.Errorf("failure query %s: %w", query, err)
	}
	return nil
